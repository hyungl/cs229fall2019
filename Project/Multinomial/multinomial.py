...
with tf.Session(graph=graph) as session:
    ...
    predictions = np.argmax(test_prediction.eval(),1)
    cnf_matrix = confusion_matrix(y_test_original, predictions)
    ...
    print(classification_report(y_test_original, predictions, target_names=class_names))
